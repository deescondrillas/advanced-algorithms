...
Para probar nuestro programa, desarrollamos 8 tests diferentes con datos desde n = 10 hasta n = 10⁸. Por defecto, el test activo es el primero, que tiene datos pequeños amigables para visualizar su ejecución.
